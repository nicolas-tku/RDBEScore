...
estimate<-function(tbl, estimRes, target){
  ...
  if(length(missingCols) == 0){
    ...
    browser()
    estim$est.total <- estimRes$estim$tHat.total * estim$est.total 
    estim$est.mean <- estimRes$estim$tHat.mean * estim$est.mean 
  } 
...
warning("this is not corrected for  upper levels for variance")
res$estim$est.mean
res$estim$var.mean
res$estim$est.total
res$estim$var.total
