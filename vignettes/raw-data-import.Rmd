...
The aim of this document is to outline the basic workflow of importing data downloaded from the [ICES Regional Database & Estimation System (RDBES)](https://sboxrdbes.ices.dk/#/) into `R` using the `icesRDBES` package.
