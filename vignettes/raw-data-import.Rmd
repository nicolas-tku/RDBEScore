...
```{r}
importedH1 <- RDBEScore:::importRDBESDataZIP("../tests/testthat/h1_v_1_19_13/H1_2022_10_05.zip")
...
```{r}
importedSL <- RDBEScore:::importRDBESDataZIP("../tests/testthat/h1_v_1_19_13/HSL_2022_10_05.zip")
#print the not NULL table names
str(importedSL)
```
...
```{r}
importedTables <- RDBEScore:::importRDBESDataZIP(zipFiles[1:3])
#print the not NULL table names
...
```{r}
importedTables <- RDBEScore:::importRDBESDataZIP(zipFiles)
#print the not NULL table names
names(importedTables[!unlist(lapply(importedTables, is.null))])
```
