...
test_that("as.integer.or.dbl successfully converts columns without large values to integer", {
  ...
  expect_is(RDBEScore:::as.integer.or.dbl(nums_as_nums[[1]]),
            "integer")
  expect_is(RDBEScore:::as.integer.or.dbl(nums_as_nums_w_na[[1]]),
            "integer")
  expect_is(RDBEScore:::as.integer.or.dbl(nums_as_nums_all_na[[1]]),
            "integer")

  expect_is(RDBEScore:::as.integer.or.dbl(nums_as_char[[1]]),
            "integer")
  expect_is(RDBEScore:::as.integer.or.dbl(nums_as_char_w_NA[[1]]),
            "integer")
...
test_that("as.integer.or.dbl successfully converts columns with large values to double/numeric", {
  ...
  expect_is(RDBEScore:::as.integer.or.dbl(nums_as_nums[[1]]),
            "numeric")
  expect_identical(RDBEScore:::as.integer.or.dbl(nums_as_nums[[1]]),
                   c(1, 2, 3, 4, 99999999999)) # NOTE - the 4.1 should be rounded DOWN to an integer 4

  expect_is(RDBEScore:::as.integer.or.dbl(nums_as_nums_w_na[[1]]),
            "numeric")
  expect_identical(RDBEScore:::as.integer.or.dbl(nums_as_nums_w_na[[1]]),
